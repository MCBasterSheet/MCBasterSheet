...
- Most receptors for signaling moelcules are in the plasma membrane
- Some are found in the cell
- The extracellular signaling molecule must diffuse through the plasma membrane to gain access to its receptor
- Vertebrates, receptors for steroid hormones are intracellular. Stroid hormones, like estrogen and testosterone, and secreted into the bloodestream from cells of endocrine glands
- Estrogen is typical of many steroids, as it is hydrophobic, it can diffuse through the plasma membrane and bind to a receptor subunit in the cell
- Some steroids bind to subunits in the cytosol, into the nucleus
- Some just go straight to the nucleus like strogen

> Estrogen receptor in mammalian cells
>
> ![image](https://github.com/MCBasterSheet/MCBasterSheet/assets/157453648/01bfa8e3-0c8a-463e-92a0-17c8a1e4c4cc)

- Past binding, the estrogen recdeptor undergoes a conformational change to let it form a dimer with another subunit that is estrogen bound
- The dimer, active estrogen recepter, binds to DNA and transcribes certain genes
  - This is a transcription factor by the way
  - Expression of specific genes changes cell structure and function in a way resulting in a cellular response

# Receptors Differ in Their Structure, Cellular Location, and Effects When Activated
- The Table below compares structures, cellular locations, and effects when activated

> ![image](https://github.com/MCBasterSheet/MCBasterSheet/assets/157453648/3a2d4b19-3141-4f0e-9529-0991cac4630d)
