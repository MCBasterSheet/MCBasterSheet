...
# Horizontal Gene Transfer Can Occur Within a Species or Between Different Species
- **Horizontal Gene Transfer** is the process where an organism incorportates genetic material from another organism without being the offspring of that organism
  - Conjugation, transformation, and transduction are examples of horizontal gene transfer
- Vertical gene transfer is when genes are passed from one generation to the next, from parents to offspring and from mother cells to daughter cell
- Conjugation, transformation, and transduction occasionally occurs between cells of different bacterial species
  - Recent years shown analyses of bacterial genomes having shown a sizable percentage of bacterial genes being derived from horizontal gene transfer
  - 17% of genes from E. coli and Salmonella typhimurium are acquired from other species by horizontal gene transfer during the past 100 million years
- Many of the genes affect traits giving cells a selective advantage, like antibiotic resistance, degrading toxic compounds, and withstanding harsh environmental conditions
  - Some are also pathogenic, turning harmless bacterial strains into one that cause disease
  - Geneticists have suggested horizontal gene transfer plays a role in evolution of different bacterial species
  - Many cases the acquisitioin of new genes lets a bacterium to survive in a new type of environment and leads to the formation of a new species
- Another reason horizontal gene transfer is important is due tot he medical relavance
  - Antibiotic resistance is widespread due to horizontal gene transfer and causes **acquired antibiotic resistance** to be more often
  - many Staphylococcus aureus strains have developed resistances to methicillin and all penicillins
  - These methicillin-resistance strains of S. aureus (MRSA) acquired it via horizontal gene transfer
